...
public:
	...
	void SendUniformVec3(std::string uniformName, glm::vec3 val) const;
	void SendUniformVec4(std::string uniformName, void* val) const;
	void SendUniformVec4(std::string uniformName, glm::vec4 val) const;
